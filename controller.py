...
class GestureManager:
    ...
    def get_position(self, hand_x_position, hand_y_position):
        ...
        ratio = 1 #cursor will move at the same speed as your hand. 
    ...
    def cursor_moving(self):
        point = 9 #select a specific landmark point on the hand.
    ...
    def adjust_volume(self):
        thumbs_up = self.Thump_finger_up and self.all_fingers_down
        thumbs_down = self.Thump_finger_down and self.all_fingers_down
    ...
    def take_screenshot_if_three_fingers_up(self):
        if self.index_finger_up and self.middle_finger_up and self.ring_finger_up:
